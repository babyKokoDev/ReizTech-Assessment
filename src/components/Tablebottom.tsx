                ...
                <ul className="inline-flex items-center -space-x-px mt-[3.5px]">
...

                    {
                        pageNumbers.map((pgNumber, index) => (
                            ...
                            <a
                                href="#"
                                className={`px-[7.5px] py-2 leading-tight border bg-gray-800 border-gray-500 text-gray-400  hover:bg-gray-700 hover:text-white text-[14.5px] duration-500 ${currentPage == pgNumber ? 'bg-gray-700 text-white' : ''}`}
